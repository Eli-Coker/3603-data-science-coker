...
- Python scalar types and how they are used (`int`, `float`, `str`, `bool`)
- How to use arithmetic operations and type casting
...
|----------|-------------|
| [01-Scalar_Types.ipynb](01-Scalar_Types.ipynb) | This notebook taught me Python's basic scalar types, arithmetic operations, and type casting. |
| [02-Control_Flow.ipynb](02-Control_Flow.ipynb) | This notebook taught me how to write conditional expressions in Python using `if`/`elif`/`else` |
